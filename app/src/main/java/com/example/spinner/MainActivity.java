...
public class MainActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        mShowAddressBtn = findViewById(R.id.showAdressBtn);
    ...
    private void initSpinnerCities(String country) {
        ...
        switch (country) {
            case "Россия":
                adapter = ArrayAdapter.createFromResource(this, R.array.r_cities, simple_spinner_item);
                break;
            case "Украина":
                adapter = ArrayAdapter.createFromResource(this, R.array.u_cities, simple_spinner_item);
                break;
            case "Белоруссия":
                adapter = ArrayAdapter.createFromResource(this, R.array.b_cities, simple_spinner_item);
                break;
        }
        if (adapter != null) {
